...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def __init__(self, args, encoder, decoder, back_encoder, back_decoder):
        super().__init__(encoder, decoder, back_encoder, back_decoder)
        self.args = args
    ...
    def build_model(cls, args, task):
        ...
        return cls(args, encoder, decoder, back_encoder, back_decoder)
    ...
    def forward(
        ...
        return decoder_out, back_decoder_out, dual_path_dist, back_data
