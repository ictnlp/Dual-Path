...
class LabelSmoothedCrossEntropyCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        """
        net_output, back_net_output, dual_loss, back_data = model(**sample["net_input"])
        ...
        logging_output = {
            ...
            "ntokens": sample["ntokens"] + back_sample["ntokens"],
            "nsentences": sample["target"].size(0) + back_sample["target"].size(0),
